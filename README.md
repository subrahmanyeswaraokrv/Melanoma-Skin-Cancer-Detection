...
![datasetdf](https://github.com/subrahmanyeswaraokrv/Melanoma-Skin-Cancer-Detection/blob/main/Readme_images/Datasetdf.png)

![datasetplot](https://github.com/subrahmanyeswaraokrv/Melanoma-Skin-Cancer-Detection/blob/main/Readme_images/DatasetPlot.png)

To overcome the issue of class imbalance, used a python package  Augmentor (https://augmentor.readthedocs.io/en/master/) to add more samples across all classes so that none of the classes have very few samples.

### Sample image from Dataset

![sample image](https://github.com/subrahmanyeswaraokrv/Melanoma-Skin-Cancer-Detection/blob/main/Readme_images/Samleimagefromdataset.png)
...
### Model Architecture
![Model Arch](https://github.com/subrahmanyeswaraokrv/Melanoma-Skin-Cancer-Detection/blob/main/Readme_images/ModelArch.png)

### Model Evaluation
![ModelEvaluation](https://github.com/subrahmanyeswaraokrv/Melanoma-Skin-Cancer-Detection/blob/main/Readme_images/ModelEvaluation.png)
